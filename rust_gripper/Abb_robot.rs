// This is an example of driving an ABB Robot in a circle, constantaly iterates using the timer elapsed
// https://github.com/robohouse-delft/abbegm-rs
//
...
// these can be passed from the arguments given on the command line
// you must give --confirm-motion 1
// options can be --bind --radius --speed
//
