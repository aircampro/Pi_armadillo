...
fn usage() {
    println!("<progname> IN_FILENAME OUT_FILENAME NUM_STRIPS")
}
...
fn main() {
    ...
    let num_strips: u8 = ns.parse().unwrap();
    ...
    use photon::effects;
    photon::conv::horizontal_strips(img, num_strips);
