...
#
# added rtsp with this https://github.com/olkham/IPyCam/blob/main/examples
#
import sys
import pygame
...
def main_run():
    ...
    config = CameraConfig.load("camera_config.json")                         # read stream config and create rtsp streamer object
    ...
    while running:
        ...
        if show_sprite:                                                   # if you want to draw a sprite you will have to make a screen boundary from the text info for this to move in   
            ...
            pygame.display.flip()
        pygame.image.save( screen, "./filename.png" )                     # create png of screen
        fr = cv2.imread("./filename.png")                                 # re-load as a frame 
        camera.stream(fr)                                                 # stream output
