...
# Communicate with KEYENCE's clamp-on flow sensor FD-Q10C via IO-LINK.
# This is a script to get the flow rate.
# Keyence Flow Sensor FD-Q10C
# water_flow.py
import time
import struct
...
def sense():
    try:
        ...
        # In the case of Eheim's 16/22 pipe, the inner diameter is 14 mm, so the nominal diameter is 3/8 of the inner diameter of 12.7 m.
...
# A library that performs IO-LINK communication using ADI's LTC2874.
# https://rabbit-note.com/2021/05/19/io-link-communication-using-raspberry-pi/
#
# ltc2874.py
#
import spidev
