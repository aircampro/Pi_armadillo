    ...
    while True:
        try:    
            ...
            if INHIB == False:
                ...
                remove_trig = read_holding_regs(client_pro, reg=170, method="tcp", cc=num_of_units, unit=1)
                remove_spt = True
                ...
                if abon == 2:
                    pi.write(AB_BLOW_ON, 1)                                                      # gpio to pump
                else:
                ...
                if wwon == 2:
                    pi.write(WW_PUMP_ON, 1)                                                      # gpio to pump
                else:
