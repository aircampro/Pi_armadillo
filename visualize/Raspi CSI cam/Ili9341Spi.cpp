 ...
 * gpioPinDc: 26
 */
Ili9341Spi::Ili9341Spi(const char* spiDevice, int gpioPinDc)
{
...
RET Ili9341Spi::setArea(uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1)
{
	uint8_t data[4];
	writeCommand(0x2A);
	data[0] = (x0 >> 8) & 0xFF;
...
RET Ili9341Spi::drawRect(uint16_t color, uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1)
{
	int width = x1 - x0 + 1;
	int height = y1 - y0 + 1;
...
RET Ili9341Spi::drawBuffer(uint16_t *buffer, uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1)
{
	setArea(x0, y0, x1, y1);
	int width = x1 - x0 + 1;
	int height = y1 - y0 + 1;
...
RET Ili9341Spi::initializeDevice()
{
...
void Ili9341Spi::writeCommand(uint8_t cmd)
{
...
void Ili9341Spi::writeData(uint8_t data)
{
...
void Ili9341Spi::writeData(uint8_t data[], uint32_t size)
{
	write(m_fdGpioDc, "1", 1);
...
RET Ili9341Spi::initializeSPI(const char* spiDevice)
{
	int ret = 0;
