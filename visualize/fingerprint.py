...
# this lib be found here https://github.com/kjanko/python-fingerprint-recognition/tree/master/enhance
#
...
SCORE_THRES = 33                          # score threshold
...
def get_descriptors(img, mode=0):
    ...
    if mode == 0:
        ...
        _, des1 = sift.detectAndCompute(img, keypoints)		
	return (keypoints, des);

# set the matcher mode 
MODE = 0

def main():
	image_name = sys.argv[1]
	img1 = cv2.imread("database/" + image_name, cv2.IMREAD_GRAYSCALE)
	kp1, des1 = get_descriptors(img1, MODE)	
