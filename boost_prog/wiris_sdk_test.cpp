/*
   g++-8 -std=c++17 -o wiris_sdk_test wiris_sdk_test.cpp -lboost_log -lpthread -DBOOST_LOG_DYN_LINK -lboost_system -lboost_regex -lboost_thread -DBOOST_ALL_DYN_LINK -lboost_log_setup -lboost_timer
*/
#include <cstdint>
#include <string>
#include <memory>
