/*
    compiles with c++11
    g++-8 -std=c++11 -o wiris_sdk_test_C11 wiris_sdk_test_C11.cpp -lboost_log -lpthread -DBOOST_LOG_DYN_LINK -lboost_system -lboost_regex -lboost_thread -DBOOST_ALL_DYN_LINK -lboost_log_setup -lboost_timer
*/
#include <cstdint>
#include <string>
#include <memory>
...
class NetworkClient
{
	public:
        ...
        /* 
		   add this methos id you are using c++11
		*/
...
void NetworkClient::connect()
{
	...
	resolver = NetworkClient::make_unique<boost::asio::ip::tcp::resolver>(*io_context);
    socket = NetworkClient::make_unique<boost::asio::ip::tcp::socket>(*io_context);
