...
int read_and_compare(std::string fil) {
    ...
    for (auto a : ss) {
        ...
        // for example look to see if we have mode (key word) in the list of tags specified in the xml file
        //
        if ((levenstein("mode", a) <= LEVENSTEIN_THRESH) || (algo::contains(a, "mode")==true)) {
            std::cout << "found " << a << "similar tag to mode with value " << std::endl;
        }
        else if ((levenstein("auro_start", a) <= LEVENSTEIN_THRESH) || (algo::contains(a, "auto_start") == true)) {
            std::cout << "found " << a << " similar to auto_start with value : " << std::endl;
        }
        else if ((levenstein("resolut", a) <= LEVENSTEIN_THRESH) || (algo::contains(a, "resolut") == true)) {
            std::cout << "found " << a << " similar to resolut with value : " << std::endl;
        }
        else if ((levenstein("trans_coord_space", a) <= LEVENSTEIN_THRESH) || (algo::contains(a, "trans_coord_space") == true)) {
            std::cout << "found " << a << " similar to trans_coord_space with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot00") == true)) {
            std::cout << "found " << a << " similar to rot00 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot01") == true)) {
            std::cout << "found " << a << " similar to rot01 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot02") == true)) {
            std::cout << "found " << a << " similar to rot02 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot10") == true)) {
            std::cout << "found " << a << " similar to rot10 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot11") == true)) {
            std::cout << "found " << a << " similar to rot11 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot12") == true)) {
            std::cout << "found " << a << " similar to rot12 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot20") == true)) {
            std::cout << "found " << a << " similar to rot20 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot21") == true)) {
            std::cout << "found " << a << " similar to rot21 with value : " << std::endl;
        }
        else if ((algo::contains(a, "rot22") == true)) {
            std::cout << "found " << a << " similar to rot22 with value : " << std::endl;
        }
        else if ((algo::contains(a, "transX") == true)) {
            std::cout << "found " << a << " similar to transX with value : " << std::endl;
        }
        else if ((algo::contains(a, "transY") == true)) {
            std::cout << "found " << a << " similar to transY with value : " << std::endl;
        }
        else if ((algo::contains(a, "transZ") == true)) {
            std::cout << "found " << a << " similar to transZ with value : " << std::endl;
        }
    }
