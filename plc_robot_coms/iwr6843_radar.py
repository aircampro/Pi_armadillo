# Python implementation for IWR6843 Texas Instrument distance radar on usb
...
# ref:- https://github.com/niekschoemaker/iwr6843aop-python/blob/master/main.py
#
...
if platform.system() == 'Linux':
    ...
    controlPort = '/dev/ttyUSB1'
elif platform.system() == "Windows":
    dataPort = 'COM6'
    controlPort = 'COM7'
elif platform.system() == "Darwin":
    dataPort = '/dev/ttyS0'
    controlPort = '/dev/ttyS1'
try:
    if args.jsonFile:
