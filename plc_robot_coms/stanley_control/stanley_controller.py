...
try:
    ...
    for sec in sections:
        if sec == "PROP":                                                                     # proportional speed controller
            Kp = float(config_ini['PID']['PB'])
            dt = float(config_ini['PID']['DT'])
            L = float(config_ini['PID']['L'])
            pomax = float(config_ini['PID']['MAX_SP'])                                                                                
            pomin = float(config_ini['PID']['MIN_SP'])
            target_speed = float(config_ini['PID']['TS'])
