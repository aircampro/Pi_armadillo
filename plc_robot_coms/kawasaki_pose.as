...
.PROGRAM pose_controller()

;SERVER id ip = 192.168.0.12 port 10000 set ID_1 to be your robots id 
...
CALL tcp_open(10000); sock_id1 = POSE_CTRL
...
$response = $RIGHT($response,LEN($response)-5)
...
PRINT "Client Communication with pose controller has failed"
